...
class UpdateViewReparacionesOnsite3 extends Migration
{
	/**
	 * Run the migrations.
	 *
	...
	private function createView(): string
	{
		return <<<SQL
                CREATE OR REPLACE
                ALGORITHM = UNDEFINED VIEW `view_reparaciones_onsite_filter_case` AS
                SELECT
	`r`.`id` AS `id`,
...
SQL;
	...
	{
		return <<<SQL
        DROP VIEW IF EXISTS `view_reparaciones_onsite_filter_case`
SQL;
		/* 
