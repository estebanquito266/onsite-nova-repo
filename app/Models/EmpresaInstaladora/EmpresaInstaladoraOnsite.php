...
class EmpresaInstaladoraOnsite extends Model
{
    ...
    {
        return $this->belongsToMany(EmpresaOnsite::class, 'empresas_instaladoras_empresas_onsite', 'empresa_instaladora_id', 'empresa_onsite_id');
    } 
    ...
    {
        return $this->hasMany(ObraOnsite::class, 'empresa_instaladora_id');
    }
}
